...
@property (nonatomic,readonly) NSNumber* ATTRIBUTE_PARAGRAPH_STYLE_LINE_BREAK_MODE_BY_WORD_WRAPPING;
@property (nonatomic,readonly) NSNumber* ATTRIBUTE_PARAGRAPH_STYLE_LINE_BREAK_MODE_BY_CHAR_WRAPPING;
@property (nonatomic,readonly) NSNumber* ATTRIBUTE_PARAGRAPH_STYLE_LINE_BREAK_MODE_BY_CLIPPING;
@property (nonatomic,readonly) NSNumber* ATTRIBUTE_PARAGRAPH_STYLE_LINE_BREAK_MODE_BY_TRUNCATING_HEAD;
@property (nonatomic,readonly) NSNumber* ATTRIBUTE_PARAGRAPH_STYLE_LINE_BREAK_MODE_BY_TRUNCATING_TAIL;
@property (nonatomic,readonly) NSNumber* ATTRIBUTE_PARAGRAPH_STYLE_LINE_BREAK_MODE_BY_TRUNCATING_MIDDLE;
